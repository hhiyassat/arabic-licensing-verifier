...
show("الحالة الوسط — مَضرِب (قراءات متنافسة) → متوقّع: Residual/Deferred",
...
# ── الحالة الكبيرة: ضارب دعوى ترخيص → Deferred (لا يوجد كتالوج جذور/أوزان معتمد)
show("الحالة الكبيرة — ضارب (دعوى Licensed رتبة عالية) → متوقّع: Deferred (نقص دليل)",
